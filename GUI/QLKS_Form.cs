...
namespace GUI
{
    public partial class QLKS_Form : Form
    {
        ...
        bool menuHRMExpand = false;

        private void timerHRMTransition_Tick(object sender, EventArgs e)
        {
            if (!menuHRMExpand)
            {
                pnHRM.Height += 10;
            ...
            {
                pnHRM.Height -= 10;
                if (pnHRM.Height <= 48) // Chiều cao khi thu gọn
                {
                    timerHRMTransition.Stop();
                    menuHRMExpand = false;
                }
        ...
        private void SetColorBackground()
        {
            ...
            btnHRM.BackColor = Color.White;
            btnHRM.ForeColor = Color.Black;

            btn_Staff.BackColor = Color.WhiteSmoke;
            btn_Staff.ForeColor = Color.Black;
            btnTimekeeping.BackColor = Color.WhiteSmoke;
        ...
        private void btnStaff_Click(object sender, EventArgs e)
        {
            pnContent.Controls.Clear();
            SetColorBackground();
            btn_Staff.BackColor = Color.Gray;
        ...
        private void btnTimekeeping_Click(object sender, EventArgs e)
        {
            pnContent.Controls.Clear();
            SetColorBackground();
            btnTimekeeping.BackColor = Color.Gray;
            btnTimekeeping.ForeColor = Color.White;
            Timekeeping home = new Timekeeping();
            home.TopLevel = false;
            pnContent.Controls.Add(home);
            home.Dock = DockStyle.Fill;
            home.Show();
        ...
        private void btnSalary_Click(object sender, EventArgs e)
        {
            pnContent.Controls.Clear();
            SetColorBackground();
            btnSalary.BackColor = Color.Gray;
            btnSalary.ForeColor = Color.White;
            Salary home = new Salary();
            home.TopLevel = false;
            pnContent.Controls.Add(home);
            home.Dock = DockStyle.Fill;
            home.Show();
